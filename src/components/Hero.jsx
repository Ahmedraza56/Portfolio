  ...
  return (
    <section className="relative w-full mx-auto h-screen">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex fle-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Ahmed Raza</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>Web Development Enthusiast</p>
        </div>
      </div>
      <ComputersCanvas />
